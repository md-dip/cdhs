...
export const sections: SectionConfig[] = [
  ...
  },
  {
    ...
    slug: "students",
    title: "শিক্ষার্থী",
    subtitle: "নতুন শিক্ষার্থী ভর্তি করুন, তথ্য সম্পাদনা বা মুছে ফেলুন।",
    columns: [
      { name: "admissionRoll", label: "ভর্তি রোল" },
      { name: "name", label: "শিক্ষার্থীর নাম" },
      { name: "className", label: "শ্রেণি" },
      { name: "gender", label: "ছাত্র/ছাত্রী" },
      { name: "session", label: "শিক্ষাবর্ষ" },
    ],
    fields: [
      { name: "name", label: "শিক্ষার্থীর নাম" },
      { name: "gender", label: "ছাত্র/ছাত্রী", type: "select", options: ["ছাত্র", "ছাত্রী"] },
      { name: "admissionRoll", label: "ভর্তি রোল" },
      { name: "classRoll", label: "শ্রেণি রোল" },
      { name: "className", label: "শ্রেণি" },
      { name: "session", label: "শিক্ষাবর্ষ" },
      { name: "group", label: "বিভাগ" },
      { name: "guardian", label: "অভিভাবকের নাম" },
      { name: "phone", label: "মোবাইল" },
      { name: "photo", label: "ছবির লিংক" },
      statusField,
    ],
  },
  {
  ...
  },
  {
    ...
    slug: "classes",
    title: "শ্রেণি ও আসন",
    subtitle: "শ্রেণি যোগ করুন, আসন সংখ্যা ও ভর্তি আবেদন চালু/বন্ধ করুন।",
    columns: [
  ...
  },
  {
    ...
    slug: "books",
    title: "পাঠ্যপুস্তক",
    subtitle: "শ্রেণিভিত্তিক পাঠ্যপুস্তক ও বিষয় কোড সম্পাদনা করুন।",
    columns: [
